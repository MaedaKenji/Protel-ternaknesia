...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // late Future<List<Map<String, dynamic>>> _futureChartData;
  Future<List<Map<String, dynamic>>> _futureChartData = Future.value([]);
  ...
  Future<List<Map<String, dynamic>>> _fetchChartData() async {
    final baseUrl = dotenv.env['BASE_URL']!;
    final port = dotenv.env['PORT']!;
    final url = '$baseUrl:$port/api/data/chart'; // API endpoint untuk grafik
